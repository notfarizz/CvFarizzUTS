...
const ContactForm = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', marginTop: '50px' }}>
      {submitted ? (
        <div style={{ textAlign: 'center', color: '#666' }}> {/* Warna teks abu-abu */}
        ...
        <form onSubmit={handleSubmit} style={{ width: '300px', border: '1px solid #ddd', padding: '20px', borderRadius: '8px', color: '#666' }}> {/* Warna teks abu-abu */}
          <h2>Contact Form</h2>
          <div style={{ marginBottom: '15px' }}>
            ...
            <input
              ...
              style={{ width: '100%', padding: '8px', marginTop: '5px', color: '#666', borderColor: '#ccc' }} // Warna teks input abu-abu
              required
            />
          </div>
          <div style={{ marginBottom: '15px' }}>
