...
export default function WarnaFavorit() {
  const [warna, setWarna] = useState<string>("yellow"); // Warna default untuk tema favorit
  ...
  return (
    <section
      style={{
        ...
        color: theme === "dark" ? "#f4f4f9" : "#333", // Atur warna teks di sini
      }}
    >
      <h1
        style={{
          ...
          fontWeight: "bold",
          marginBottom: "20px",
          color: theme === "dark" ? "#f4f4f9" : "#333", // Pastikan warna h1 berubah
        }}
      >
        Pilih Tema Latar
      </h1>
